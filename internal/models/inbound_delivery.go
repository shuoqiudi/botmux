...
const (
	...
	InboundRetrying              = "RETRYING"
	InboundSucceeded             = "SUCCEEDED"
	InboundDLQ                   = "DLQ"
	InboundRejectedUnknownRoute  = "REJECTED_UNKNOWN_ROUTE"
	InboundRejectedRouteDisabled = "REJECTED_ROUTE_DISABLED"
)
